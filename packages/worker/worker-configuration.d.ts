/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 257e5504a20641a34464bc5658d1d350)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		SITE_TITLE: "Yizhe's Token Usage";
		SITE_ID: string;
		ENROLL_TOKEN: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MAX_DEVICES" | "PUBLIC_PROJECT_VISIBILITY" | "DEFAULT_TIMEZONE" | "SITE_TITLE" | "SITE_ID" | "ENROLL_TOKEN" | "DEVICE_TOKEN_SECRET" | "PROJECT_NAME_SALT">> {}
}
