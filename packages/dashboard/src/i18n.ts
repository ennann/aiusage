...
export const I18N = {
  en: {
    ...
    shareButton: 'Share',
    shareTitle: 'Share Your AI Usage',
    shareDesc: 'Generate a beautiful card image of your AI usage stats',
    sharePreview: 'Preview',
    shareDownload: 'Save Image',
    shareCopy: 'Copy Image',
    shareCopySuccess: 'Image copied to clipboard!',
    shareCopyFail: 'Copy failed, please save the image instead',
    shareTwitter: 'Share to X',
    shareClose: 'Close',
    shareWatermark: 'AI Usage Stats',
    shareGenerated: 'Generated by AI Usage',
    sharePeriod: 'Period',
    shareTotalCost: 'Total Cost',
    shareTotalTokens: 'Total Tokens',
    shareSessions: 'Sessions',
    shareActiveDays: 'Active Days',
    shareCacheHit: 'Cache Hit',
    shareTopModels: 'Top Models',
    shareTopProviders: 'Top Providers',
  },
  zh: {
    ...
    shareButton: '分享',
    shareTitle: '分享你的 AI 用量',
    shareDesc: '生成精美的 AI 用量统计卡片图片',
    sharePreview: '预览',
    shareDownload: '保存图片',
    shareCopy: '复制图片',
    shareCopySuccess: '图片已复制到剪贴板！',
    shareCopyFail: '复制失败，请改用保存图片',
    shareTwitter: '分享到 X',
    shareClose: '关闭',
    shareWatermark: 'AI Usage 统计',
    shareGenerated: 'Generated by AI Usage',
    sharePeriod: '时间范围',
    shareTotalCost: '总费用',
    shareTotalTokens: '总 Token',
    shareSessions: '会话数',
    shareActiveDays: '活跃天数',
    shareCacheHit: '缓存命中',
    shareTopModels: '热门模型',
    shareTopProviders: '热门厂商',
  },
} as const;
