...
export const I18N = {
  en: {
    ...
    claudeCodeDataNotice: 'Claude Code started logging full token telemetry around Feb 2026; earlier activity may be undercounted.',
  ...
  zh: {
    ...
    claudeCodeDataNotice: 'Claude Code 约于 2026 年 2 月起开始记录完整的 Token 遥测数据，更早的活动可能未被完整统计。',
